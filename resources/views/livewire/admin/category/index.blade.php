<div class="min-h-screen mb-4 rounded-lg shadow-xl dark:-gray-600">
    ...
    <section class="p-3 antialiased bg-gray-50 dark:bg-gray-900 sm:p-5">
        <h3 class="mt-3 text-3xl font-bold dark:text-white">Categorias</h3>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="relative w-full">
                                ...
                                <input type="text" id="simple-search" wire:keydown="searchElement()"
                                    ...
                                    placeholder="Buscar categorias" required="">
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <tbody>
                            @foreach ($values as $category)
                                <tr class="border-b dark:border-gray-700">
                                    <td class="px-4 py-3 ">
                                        <img src="{{ Storage::url($category->image_path) }}" alt="{{ $category->name }}" class="w-24 h-24 object-cover rounded-lg">
                                    </td> 
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <div class="flex items-center">
                                            <div class="w-6 h-6 mr-2 rounded" style="background-color: {{ $category->color }};"></div>
                                            {{ $category->color }}
                                        </div>
                                    </td>                                                                                                 
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex flex-col items-start gap-2">
                                            ...
                                            <a href="{{ route('categories.subcategories.index', $category->id) }}"
